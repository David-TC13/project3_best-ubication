...
def st_b_zn(token):
    url = "https://api.foursquare.com/v3/places/search?query=starbucks&ll=37.764760,-122.406779&radius=500&limit=5"
...
def bs_st_zn(token):
    ...
    url = "https://api.foursquare.com/v3/places/search?ll=37.764760,-122.406779&radius=1000&categories=19043&limit=3"
...
def park(token):
    url = "https://api.foursquare.com/v3/places/search?ll=37.764760,-122.406779&radius=500&categories=19020&limit=1"
...
def airport(token):
    ...
    url = "https://api.foursquare.com/v3/places/search?ll=37.764760,-122.406779&radius=50000&categories=19040&limit=1"
...
def schools(token):
    url = "https://api.foursquare.com/v3/places/search?ll=37.764760,-122.406779&radius=5000&categories=12057&limit=5"
...
def restaurant(token):
    url = "https://api.foursquare.com/v3/places/search?ll=37.764760,-122.406779&radius=500&categories=13377&limit=1"
...
def basketball(token):
    url = "https://api.foursquare.com/v3/places/search?ll=37.764760,-122.406779&radius=10000&categories=18008&limit=1"
...
def def_zg(starbucks,bus_stop,parking,airport,school,restaurant,basketball):
    ...
    df_zg= list_places_nearby(list_conditions)
    return df_zg
