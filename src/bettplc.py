...
def st_b_zn(token):
    url = "https://api.foursquare.com/v3/places/search?query=starbucks&ll=37.394264,-122.149029&radius=500&limit=1"
    headers = {
...
def bs_st_zn(token):
    ...
    url = "https://api.foursquare.com/v3/places/search?ll=37.394264,-122.149029&radius=1000&categories=19043&limit=3"
...
def park(token):
    url = "https://api.foursquare.com/v3/places/search?ll=37.394264,-122.149029&radius=500&categories=19020&limit=1"
...
def airport(token):
    ...
    url = "https://api.foursquare.com/v3/places/search?ll=37.394264,-122.149029&radius=50000&categories=19040&limit=1"
    headers = {
        "accept": "application/json",
        "Authorization": (token)
    }
...
def schools(token):
    url = "https://api.foursquare.com/v3/places/search?ll=37.394264,-122.149029&radius=5000&categories=12009&limit=5"
    headers = {
        "accept": "application/json",
        "Authorization": (token)
    }
...
def restaurant(token):
    url = "https://api.foursquare.com/v3/places/search?ll=37.394264,-122.149029&radius=500&categories=13377&limit=1"
    headers = {
        "accept": "application/json",
        "Authorization": (token)
    }
...
def basketball(token):
    url = "https://api.foursquare.com/v3/places/search?ll=37.394264,-122.149029&radius=10000&categories=18008&limit=1"
